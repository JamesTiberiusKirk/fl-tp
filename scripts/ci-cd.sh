...
docker build -t ghcr.io/jamestiberiuskirk/fl-tp:latest . --build-arg PAT=$PAT
docker push ghcr.io/jamestiberiuskirk/fl-tp:latest # This is disabled in the template